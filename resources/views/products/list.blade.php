...
<section class="section-content padding-y">
    ...
    <header class="mb-3">
            <div class="form-inline">
                ...
                <div class="btn-group">
                    ...
                    <a href="{{route('products.index')}}" class="btn btn-light active" data-toggle="tooltip" title="Grid view">
    ...
    <article class="card card-product-list">
        <div class="row no-gutters">
            ...
            <div class="col-md-6">
                <div class="info-main">
                    <a href="{{ route('products.show', $product->slug) }}" class="h5 title"> {{ $product->title }}</a>
            ...
            <aside class="col-sm-3">
                <div class="info-aside">
                    <div class="price-wrap">
                        <span class="h5 price">{{ $product->getPrice() }}</span>
