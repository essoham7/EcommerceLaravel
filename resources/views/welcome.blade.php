...
<div class="container">
    <!-- ========================= SECTION MAIN  ========================= -->
    <section class="section-main padding-y shadow-lg">
    <main class="card">
        <div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-md-9 col-xl-7 col-lg-7 shadow-lg">
    ...
    <div id="carousel1_indicator" class="slider-home-banner carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src=" {{ asset('img/slider/slide1.jpg?v=2.0') }} " alt="First slide">
        </div>
        <div class="carousel-item">
          <img src=" {{ asset('img/slider/slide2.jpg?v=2.0') }} " alt="Second slide">
        </div>
        <div class="carousel-item">
          <img src=" {{ asset('img/slider/slide3.jpg?v=2.0')}} " alt="Third slide">
        </div>
      </div>
    ...
    <!-- =============== SECTION DEAL =============== -->
    <section class="padding-bottom shadow-lg">
    ...
    <div class="row no-gutters">
        ...
        <div class="home-category-banner bg-light-orange shadow-lg">
            <h5 class="title">Machinery items for manufacturers</h5>
            <p>Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
            <a href="#" class="btn btn-outline-primary rounded-pill">Source now</a>
            <img src=" {{ asset('img/products/1.jpg')}} " class="img-bg">
        </div>
    ...
    <a href="#" class="item">
        <div class="card-body">
            ...
            <img class="img-sm float-right" src=" {{ asset('img/products/2.jpg')}}">
            <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Tokyo, Japan</p>
        </div>
    </a>
        </li>
    ...
    <a href="#" class="item">
        <div class="card-body">
            ...
            <img class="img-sm float-right" src=" {{ asset('img/products/3.jpg')}}">
            <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Hong Kong, China</p>
        </div>
    </a>
        </li>
    ...
    <a href="#" class="item">
        <div class="card-body">
            <h6 class="title">Home and kitchen electronic  stuff collection  </h6>
            <img class="img-sm float-right" src=" {{ asset('img/products/4.jpg')}}">
            <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Tashkent, Uzb</p>
        </div>
    </a>
        </li>
    ...
    <a href="#" class="item">
        <div class="card-body">
            ...
            <img class="img-sm float-right" src=" {{ asset('img/products/5.jpg')}}">
            <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
        </div>
    </a>
        </li>
    ...
    <a href="#" class="item">
        <div class="card-body">
            <h6 class="title">Home and kitchen electronic  stuff collection  </h6>
            <img class="img-sm float-right" src=" {{ asset('img/products/6.jpg')}}">
            <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
        </div>
    </a>
        </li>
    ...
    <a href="#" class="item">
        <div class="card-body">
            <h6 class="title">Home and kitchen electronic  stuff collection  </h6>
            <img class="img-sm float-right" src=" {{ asset('img/products/7.jpg')}}">
            <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
        </div>
    </a>
        </li>
    ...
    <a href="#" class="item">
        <div class="card-body">
            <h6 class="title">Home and kitchen electronic  stuff collection  </h6>
            <img class="img-sm float-right" src=" {{ asset('img/products/8.jpg')}}">
            <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
    ...
    <a href="#" class="item">
        <div class="card-body">
            <h6 class="title">Home and kitchen electronic  stuff collection  </h6>
            <img class="img-sm float-right" src=" {{ asset('img/products/9.jpg')}}">
            <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
        </div>
    </a>
        </li>
    ...
    <div class="row shadow-lg">
        <div class="col-md-8">
    <div class="card-banner banner-quote overlay-gradient" style="background-image: url('img/slider/slide1.jpg');">
    ...
    <div class="row row-sm shadow-lg">

        @foreach ($products as $product)

        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
            <div class="card card-sm card-product-grid">
                <a href="{{ route('products.show', $product->slug) }}" class="img-wrap"> <img src=" {{ $product->image1 }} "> </a>
                <figcaption class="info-wrap">
                    <h6 class="card-title"><a href="{{ route('products.show', $product->slug) }}" class="title"> {{ $product->title }} </a></h6>
                    {{-- <p>{{ $product->created_at->format('d/m/y') }}</p> --}}
                    <div class="price mt-1">{{ $product->getPrice() }}</div> <!-- price-wrap.// -->
                    {{-- <button class="btn btn-danger btn-circle btn-lg"><i class="fa fa-shopping-cart "></i> </button> <!-- button.// --> --}}
